      ...
      <div className="min-h-screen flex flex-col p-2 bg-gradient-to-br from-background from-30% dark:from-40%  to-transparent">
        ...
        <div className='flex-grow z-10 flex flex-col justify-center md:pl-8'>
          <div>
            ...
            <p className='font-extrabold text-5xl'>{(working === 'LOG IN') ? 'Log in to your account' : 'Create new account'} <span className='inline-block w-5 h-5 leading-3 rounded-full text-transparent bg-primary'>.</span> </p>
